...
// @routes   GET api/profile  (no ID needed since this is the user's own profile. Just get that data from the JWT)
...
router.get(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }) // grabs current user's id from Profile schema
