...
class PostItem extends Component {
  ...
  render() {
    const { post, auth, showActions } = this.props; // we get this.props.post from parent component
    return (
...
const mapStateToProps = state => ({
  auth: state.auth, // so only post author can delete a post // this gives us this.props.auth
})
